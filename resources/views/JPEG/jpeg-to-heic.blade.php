        ...
        <div class="row">
            <div class="col-md-12">
                <div class="text-center convertjpgtopdf_main">
                    <h1 class="convertjpgtopdf">JPEG to HEIC</h1>
                    <h2 class="bestjpgtopdf">Convert JPEG images to HEIC in seconds. Easily adjust orientation and
                        margins.
                    </h2>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-12 text-center">
                <h3 class="mb-4">How to convert JPEG to HEIC.</h3>
            </div>
                    ...
                    <a href="topics-detail.html">
                        <div class="d-flex">
                            <div>
                                ...
                                <p class="mb-0">Choose a JPEG image from your photo library that is less than 2GB in
                                    size.</p>
                            </div>
                    ...
                    <a href="topics-detail.html">
                        <div class="d-flex">
                            <div>
                                ...
                                <p class="mb-0">Upload your image to automatically convert it to HEIC format in an
                                    instant.</p>
                            </div>
