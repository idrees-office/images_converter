        ...
        <div class="row">
            <div class="col-md-12">
                <div class="text-center convertjpgtopdf_main">
                    <h1 class="convertjpgtopdf">JPG to TIFF</h1>
                    <h2 class="bestjpgtopdf">Convert JPG images to TIFF in seconds. Easily adjust orientation and
                        margins.
                    </h2>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-12 text-center">
                <h3 class="mb-4">How to convert JPG to TIFF.</h3>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-12 m-auto">
                <h3 class="mb-4 text-center">About JPG To TIFF</h3>
