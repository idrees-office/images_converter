        ...
        <div class="row">
            <div class="col-md-12">
                <div class="text-center convertjpgtopdf_main">
                    <h1 class="convertjpgtopdf">JPG to WEBP</h1>
                    <h2 class="bestjpgtopdf">Convert JPG images to WEBP in seconds. Easily adjust orientation and
                        margins.
                    </h2>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-12 text-center">
                <h3 class="mb-4">How to convert JPG to WEBP.</h3>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-12 m-auto">
                <h3 class="mb-4 text-center">About JPG To WEBP</h3>
                <p>Converting JPG to WEBP is a common image file format transformation. JPG (Joint Photographic Experts Group) and PNG (Portable Network Graphics) are both popular image formats, but they serve different purposes and have distinct characteristics.
                </p>
                ...
                <p>WEBP, on the other hand, is a lossless compression format suitable for images with sharp edges, transparency, and limited colors. It retains all image data and offers excellent quality but usually results in larger file sizes compared to JPG.
                </p>
                {{-- <div class="row my-4">
